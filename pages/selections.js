...
export default function Selections() {
    ...
    return (
        ...
        <div className='p-5 flex flex-col justify-center items-center w-screen'>
            ...
            <div onClick={() => setMessage(flowers)} className={`bg-[url('https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/56560e51-e117-4794-9003-f0c82ec18c5d/original=true/39002-g.jpeg')] bg-center h-[8vh] text-white cursor-pointer rounded-md  px-5 py-3 my-2 shadow-lg font-prophet ${message === flowers ? 'opacity-100':'opacity-60'}`}>Flowers</div>
            <div onClick={() => setMessage(robots)}  className={`bg-[url('https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/fc654523-70a9-4fad-8301-b5283f66b876/original=true/00312-465935130-((An%20robots%20in%20a%20last_supper))%20(robots%20with%20computer%20monitors%20with%20faces%20instead%20%20of%20heads)%20(masterpiece_1.2)%20(photorealistic_1.jpeg')] bg-center h-[8vh] text-white cursor-pointer rounded-md px-5 py-3 my-2 shadow-lg font-prophet ${message === robots ? 'opacity-100':'opacity-60'}`}>Robots</div>
            <div onClick={() => setMessage(thunderstorm)} className={`bg-[url('https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/7bbc76e3-8106-49e3-91e6-4933a6f81322/original=true/00019-1057663555.jpeg')] bg-center h-[8vh] text-white cursor-pointer rounded-md px-5 py-3 my-2 shadow-lg font-prophet ${message === thunderstorm ? 'opacity-100':'opacity-60'}`}>Thunderstorm</div>
            <div onClick={() => setMessage(forest)} className={`bg-[url('https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/1d7adfad-280d-4cc5-8c88-97f3a42cb7b5/original=true/8088900BBA42AB5468EFEAE413FD1584F4F2ED2F8DB7A12E06D3E3E1E945503D.jpeg')] bg-center h-[8vh] text-white cursor-pointer rounded-md px-5 py-3 my-2 shadow-lg font-prophet ${message === forest ? 'opacity-100':'opacity-60'}`}>Forest</div>
            <div onClick={() => setMessage(birds)} className={`bg-[url('https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/47c9a52d-0bd1-4b9e-b38d-069ac11f97cb/original=true/10947-1530712919-Bird,%20caravaggio%20style.jpeg')] bg-center h-[8vh] text-white cursor-pointer rounded-md px-5 py-3 my-2 shadow-lg font-prophet ${message === birds ? 'opacity-100':'opacity-60'}`}>Birds</div>
            </div>
        </div>
        </>
    );
